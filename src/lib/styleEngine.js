const COLOR_RULES = [
  { color: 'black', terms: ['black', 'noir', 'obscura', 'ebene', 'obsidian', 'nocturne', 'midnight', 'onyx', 'eclipse', 'shadow', 'panther'] },
  { color: 'white', terms: ['white', 'blanche', 'blanc', 'purete', 'halo', 'cloud'] },
  { color: 'cream', terms: ['cream', 'creme', 'ivory'] },
  { color: 'green', terms: ['green', 'verdant', 'verte', 'groove', 'emerald', 'emeraude', 'forest', 'sage'] },
  { color: 'blue', terms: ['blue', 'azur', 'saphir', 'ciel', 'sapphire', 'marine', 'breeze'] },
  { color: 'pink', terms: ['pink', 'rose', 'poudre', 'aurora'] },
  { color: 'orange', terms: ['orange', 'ambre', 'amber'] },
  { color: 'yellow', terms: ['yellow', 'soleil', 'jaune', 'volt'] },
  { color: 'red', terms: ['red', 'rouge', 'ecarlate', 'intensite', 'scarlet', 'blaze', 'cherry'] },
